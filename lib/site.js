...
export default class Site {
    constructor(resources) {
        ...
        this._articles = sortByKeyDesc(this._articles, getArticleDate);

        for (const key of Object.keys(this._articlesByTag)) {
            const articles = this._articlesByTag[key];
            this._articlesByTag[key] = sortByKeyDesc(articles, getArticleDate);
        }
    }
