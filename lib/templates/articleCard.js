...
export function renderArticleCardList(articles) {
    return h('ul', { class: 'article-card-list' }, articles.map(renderArticleCardItem));
}

export function renderArticleCardItem(article) {
